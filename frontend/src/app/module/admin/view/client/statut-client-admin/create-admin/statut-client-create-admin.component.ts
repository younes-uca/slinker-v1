...
@Component({
  selector: 'app-statut-client-create-admin',
  templateUrl: './statut-client-create-admin.component.html'
})
export class StatutClientCreateAdminComponent extends AbstractCreateController<StatutClientDto, StatutClientCriteria, StatutClientService>  implements OnInit {
