...
@Component({
  selector: 'app-affliate-edit-admin',
  templateUrl: './affliate-edit-admin.component.html'
})
export class AffliateEditAdminComponent extends AbstractEditController<AffliateDto, AffliateCriteria, AffliateService>   implements OnInit {
