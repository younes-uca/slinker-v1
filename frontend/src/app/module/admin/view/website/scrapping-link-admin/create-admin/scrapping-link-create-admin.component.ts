...
@Component({
  selector: 'app-scrapping-link-create-admin',
  templateUrl: './scrapping-link-create-admin.component.html'
})
export class ScrappingLinkCreateAdminComponent extends AbstractCreateController<ScrappingLinkDto, ScrappingLinkCriteria, ScrappingLinkService>  implements OnInit {
