...
@Component({
  selector: 'app-statut-notification-create-admin',
  templateUrl: './statut-notification-create-admin.component.html'
})
export class StatutNotificationCreateAdminComponent extends AbstractCreateController<StatutNotificationDto, StatutNotificationCriteria, StatutNotificationService>  implements OnInit {
