...
@Component({
  selector: 'app-subscription-type-edit-admin',
  templateUrl: './subscription-type-edit-admin.component.html'
})
export class SubscriptionTypeEditAdminComponent extends AbstractEditController<SubscriptionTypeDto, SubscriptionTypeCriteria, SubscriptionTypeService>   implements OnInit {
