...
@Component({
  selector: 'app-subscription-pack-edit-admin',
  templateUrl: './subscription-pack-edit-admin.component.html'
})
export class SubscriptionPackEditAdminComponent extends AbstractEditController<SubscriptionPackDto, SubscriptionPackCriteria, SubscriptionPackService>   implements OnInit {
