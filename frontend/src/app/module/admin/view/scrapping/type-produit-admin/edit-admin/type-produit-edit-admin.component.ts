...
@Component({
  selector: 'app-type-produit-edit-admin',
  templateUrl: './type-produit-edit-admin.component.html'
})
export class TypeProduitEditAdminComponent extends AbstractEditController<TypeProduitDto, TypeProduitCriteria, TypeProduitService>   implements OnInit {
