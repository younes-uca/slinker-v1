...
public class StatutClient   extends AuditBusinessObject     {
    ...
    public StatutClient(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        StatutClient statutClient = (StatutClient) o;
        return id != null && id.equals(statutClient.id);
    }
