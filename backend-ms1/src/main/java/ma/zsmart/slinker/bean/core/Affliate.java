...
public class Affliate   extends AuditBusinessObject     {
    ...
    public Affliate(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        Affliate affliate = (Affliate) o;
        return id != null && id.equals(affliate.id);
    }
