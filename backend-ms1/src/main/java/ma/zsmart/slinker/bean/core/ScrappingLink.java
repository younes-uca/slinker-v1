...
public class ScrappingLink   extends AuditBusinessObject     {
    ...
    public ScrappingLink(){
        super();
    }

    public ScrappingLink(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        ScrappingLink scrappingLink = (ScrappingLink) o;
        return id != null && id.equals(scrappingLink.id);
    }
