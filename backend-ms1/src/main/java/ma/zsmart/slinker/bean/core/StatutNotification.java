...
public class StatutNotification   extends AuditBusinessObject     {
    ...
    public StatutNotification(){
        super();
    }

    public StatutNotification(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        StatutNotification statutNotification = (StatutNotification) o;
        return id != null && id.equals(statutNotification.id);
    }
