...
public class StatutWebSite   extends AuditBusinessObject     {
    ...
    public StatutWebSite(){
        super();
    }

    public StatutWebSite(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        StatutWebSite statutWebSite = (StatutWebSite) o;
        return id != null && id.equals(statutWebSite.id);
    }
