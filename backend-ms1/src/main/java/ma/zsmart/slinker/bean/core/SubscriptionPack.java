...
public class SubscriptionPack   extends AuditBusinessObject     {
    ...
    public SubscriptionPack(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        SubscriptionPack subscriptionPack = (SubscriptionPack) o;
        return id != null && id.equals(subscriptionPack.id);
    }
