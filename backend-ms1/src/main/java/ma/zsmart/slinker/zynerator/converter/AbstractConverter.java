package ma.zsmart.slinker.zynerator.converter;


import ma.zsmart.slinker.zynerator.bean.Etablissement;
import ma.zsmart.slinker.zynerator.dto.EtablissementDto;

import ma.zsmart.slinker.zynerator.util.ListUtil;
import ma.zsmart.slinker.zynerator.audit.AuditBusinessObject;
import ma.zsmart.slinker.zynerator.bean.BusinessObject;
import ma.zsmart.slinker.zynerator.dto.AuditBaseDto;
import ma.zsmart.slinker.zynerator.dto.BaseDto;
import ma.zsmart.slinker.zynerator.util.DateUtil;
import ma.zsmart.slinker.zynerator.util.RefelexivityUtil;
import ma.zsmart.slinker.zynerator.util.StringUtil;
import ma.zsmart.slinker.zynerator.util.Utils;
