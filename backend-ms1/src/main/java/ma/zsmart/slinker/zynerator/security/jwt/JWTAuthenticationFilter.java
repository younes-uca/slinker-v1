package ma.zsmart.slinker.zynerator.security.jwt;
...
import ma.zsmart.slinker.SlinkerApplication;
import ma.zsmart.slinker.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = SlinkerApplication.getCtx().getBean(UserService.class);
